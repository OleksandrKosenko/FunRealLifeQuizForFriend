...
class HintView: UIView, PopUpable {
    ...
    func setupInfoAnimationView() {
        ...
        lottieAnimationView = .init(name: "idea")
        lottieAnimationView.frame = CGRect(x: (frame.size.width - 350) / 2, y: (frame.size.height - 390), width: 350, height: 180)
