...
class NotFoundView: UIView, PopUpable {
    ...
    func setupInfoAnimationView() {
        ...
        lottieAnimationView = .init(name: "not-found")
        lottieAnimationView.frame = CGRect(x: (frame.size.width - 310) / 2, y: (frame.size.height - 360), width: 310, height: 130)
